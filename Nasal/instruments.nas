...
setprop("yak-40/instrumentation/uvid-15/indicated-wheels_dec_m", 
(alt/10.0) - int( alt/100.0 )*10.0 );

setprop("yak-40/instrumentation/uvid-15/indicated-wheels_hund_m", 
(alt/100.0) - int( alt/1000.0 )*10.0 );

setprop("yak-40/instrumentation/uvid-15/indicated-wheels_ths_m", 
(alt/1000.0) - int( alt/10000.0 )*10.0 );

setprop("yak-40/instrumentation/uvid-15/indicated-wheels_decths_m", 
...
setprop("yak-40/instrumentation/uvid-15/mmhg", pressure );

setprop("yak-40/instrumentation/uvid-15/mmhg-wheels_dec", 
(pressure/10.0) - int( pressure/100.0 )*10.0 );

setprop("yak-40/instrumentation/uvid-15/mmhg-wheels_hund", 
